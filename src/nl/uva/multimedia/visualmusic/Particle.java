...
public class Particle {
    ...
    public int nextColor(float ratio){
        ...
        int red = (int) (Color.red(this.begin_color) * ratio +
                Color.red(this.end_color) * (1 - ratio));
        int green = (int) (Color.green(this.begin_color) * ratio +
                (Color.green(this.end_color) * (1 - ratio)));
        int blue = (int) (Color.blue(this.begin_color) * ratio +
                (Color.blue(this.end_color)  * (1 - ratio)));
    ...
    public boolean isDead() {
        if (age >= life_time)
            return (this.dead = true); /* Setting it, not comparing it. */
        return false;
    }
